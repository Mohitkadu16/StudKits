        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-center p-6 backdrop-blur-md bg-white/10 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 rounded-xl">
            <h3 className="font-semibold text-foreground mb-4">
              <a href="/contact" aria-label="Visit our contact page">Contact Us</a>
            </h3>
            <div className="space-y-2" role="list">
              ...
              <a 
                ...
                rel="noopener noreferrer"
                className="flex items-center justify-center hover:text-foreground/90 transition-colors"
                aria-label="Follow us on Instagram @studkits.shop"
                role="listitem"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4 mr-2 fill-current" aria-hidden="true" focusable="false">
                ...
                <span>@studkits.shop</span>
              </a>
              <a 
                href="mailto:studkits25@gmail.com" 
                className="flex items-center justify-center hover:text-foreground/90 transition-colors"
                aria-label="Email us at studkits25@gmail.com"
                role="listitem"
              >
                <Mail className="h-4 w-4 mr-2" aria-hidden="true" />
                <span>studkits25@gmail.com</span>
              </a>
            </div>
          ...
          {/* Social Links */}
          <div className="text-center p-6 backdrop-blur-md bg-white/10 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 rounded-xl">
            <h3 className="font-semibold text-foreground mb-4" id="social-links">Follow Us</h3>
            <div className="space-y-2" role="list" aria-labelledby="social-links">
              <a 
                href="https://instagram.com/studkits.shop" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                ...
                rel="noopener noreferrer"
                className="flex items-center justify-center hover:text-foreground/90 transition-colors"
                aria-label="Subscribe to our YouTube channel @studkits-shop"
                role="listitem"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4 mr-2 fill-current" aria-hidden="true" focusable="false">
