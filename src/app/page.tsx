...
export default function HomePage() {
  ...
  return (
    <div className="space-y-24 bg-[rgb(15,23,42)]">
      {/* Hero Section */}
      <section className="text-center py-6 sm:py-8 lg:py-10 rounded-lg shadow-lg relative overflow-hidden">
        <div className="absolute inset-0 backdrop-blur-sm"></div>
        <div className="absolute inset-0 bg-gradient-to-b to-transparent"></div>
        <MaxWidthWrapper className="relative">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#4285F4] mb-8 leading-tight hero-heading border-white">
            Turn Your College Projects into Real Innovations 🚀
          </h1>
